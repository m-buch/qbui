          ...
          <ResizablePanelGroup direction="vertical" class="flex-1 overflow-hidden">
            ...
            <ResizablePanel :default-size="71.5" class="flex flex-col overflow-hidden">
              <ScrollArea class="flex-1 overflow-y-auto relative">
                ...
                <TheSearchPanel v-else-if="uiStore.isSearchActive" />
                <TheSettingsPanel v-else-if="uiStore.isSettingsActive" />
                <TheAddTorrentPanel v-else />
              </ScrollArea>
            </ResizablePanel>
...
import TheAddTorrentPanel from '@/components/TheAddTorrentPanel.vue'
